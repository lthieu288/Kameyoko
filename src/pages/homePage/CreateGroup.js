                        ...
                        <div className="col-xl-5 col-md-8">
                            <form onSubmit={handleSubmit(create)} className="bg-white  rounded-5 shadow-5-strong p-5">
                                <div className="form-outline mb-4">
                                    <label className="form-label" for="form1Example1">Name Group</label>
                                    <input type="text" id="form1Example1" className="form-control" {...register("name")} />
                                    <p className="error">{errors.name?.message}</p>
                                </div>
                                <button type="submit" className="btn btn-primary btn-block">Create Group</button>
                                <button style={{ marginLeft: 10, backgroundColor: "red" }} className="btn btn-primary btn-block">
