                        ...
                        <div className="form-outline d-flex">
                            {
                                disable === true ?
                                    ...
                                    :
                                    <button type="button" className="btn btn-primary" onClick={createNewSlide}>
                                        <AddIcon></AddIcon>
                                        New slide
                                    </button>
                    ...
                    </div>
                    {
                        slides.length === 0 ?
                            ...
                            <Row className="my-3">
                                <div className="col-2">
                                    {slides?.map((sl) => (
                                        <div className="" onClick={() => (setIdSlide(sl.id) ,
                                ...
                                {
                                    idSlide === undefined ?
                                        <CreateQuestion parentCallback={callbackFunction} idSlide={id}
                                                        parentRender={callbackFunctionRender}/>
                                        :
                                        <EditQuestion idContent={idContent} id={idSlide} title={title}
                                                      options={listOption} parentCallback={callbackFunction}/>
                                }
                            </Row>
