...
function EditProfile() {
    ...
    function ProfileUser() {
        getProfile(currentUser.data.token).then((data) => {
            setUser(data.user)
    ...
    const handleSubmitEditProfile = async (data) => {
        ...
        editProfile(currentUser.data.token, editUser).then((response) => {
                        ...
                        <div className="col-xl-4">
                            <div className="card mb-4 mb-xl-0">
                                ...
                                <div className="card-body text-center">
                                    {
                                        image === "" ?
                                            <img style={{borderRadius: "50% !important", height: "12rem", width: "12rem"}}
                                                 className="img-account-profile rounded-circle mb-2"
                                                 src="http://bootdey.com/img/Content/avatar/avatar1.png" alt=""/>
                                            :
                                            <img style={{borderRadius: "50% !important", height: "12rem", width: "12rem"}}
                                                 className="img-account-profile rounded-circle mb-2" src={image} alt=""/>
                                    }
                                    ...
                                    <form onSubmit={handleSubmit(handleSubmitEditProfile)}>
                                        <div className="mb-3">
                                            ...
                                            <input className="form-control" id="inputUsername" type="text"
                                                   ...
                                                   defaultValue={user.full_name} {...register("full_name")} />
                                            <p className="error" style={{color: "red"}}>{errors.full_name?.message}</p>
                                        </div>
                                        <div className="mb-3">
                                            <label className="small mb-1" htmlFor="inputFirstName">User name</label>
                                            <input className="form-control" id="inputFirstName" type="text"
                                                   placeholder="Enter your first name"
                                                   defaultValue="Valerie"  {...register("username")}/>
